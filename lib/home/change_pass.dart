...
class ChangePasswordClass extends StatefulWidget {
  final String email;
  ChangePasswordClass({this.email});
  @override
  _ChangePasswordClassState createState() => _ChangePasswordClassState();
}

class _ChangePasswordClassState extends State<ChangePasswordClass> {
  ...
  ConfirmPasswordBloc _passwordBloc;
  var _isLoading = false;

  @override
  void initState() {
    super.initState();
    _passwordBloc = ConfirmPasswordBloc();
      ...
      child: RaisedButton(
        ...
        onPressed: () {
          ...
          if (_confirmController.text.isEmpty) {
            _showAlert(context, "Enter Confirm password.");
          } else if (_newController.text != _confirmController.text) {
            _showAlert(context, "Password and Confirm Password mismatched.");
          } else {
            var data = {"email": widget.email, "password": _newController.text};
            _passwordBloc.sendotp(data);
          }
        },
